...
func TestValidator_ValidateJson(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			schema:      Schema{Type: Types{"number"}},
			data:        123.45,
			expectValid: true,
		},
		{
			name:        "type integer valid float",
			schema:      Schema{Type: Types{"integer"}},
			data:        123.0,
			expectValid: true,
		},
		{
		...
		},
		{
			...
			schema:      Schema{Type: Types{"boolean"}},
			data:        true,
			expectValid: true,
		},
		{
		...
		},
		{
			...
			schema:      Schema{Type: Types{"array"}},
			data:        []any{1, 2},
			expectValid: true,
		},
		{
			name:        "type object valid",
			schema:      Schema{Type: Types{"object"}},
		...
		// --- String Validation ---
		{
			...
			schema:      Schema{Type: Types{"string"}, MaxLength: ptrInt64(5)},
			data:        "hello",
			expectValid: true,
		},
		{
		...
		},
		{
			...
			schema:      Schema{Type: Types{"string"}, MinLength: ptrInt64(2)},
			data:        "hi",
			expectValid: true,
		},
		{
		...
		},
		{
			...
			schema:      Schema{Type: Types{"string"}, Pattern: "^[a-z]+$"},
			data:        "abc",
			expectValid: true,
		},
		{
		...
		// --- Number Validation ---
		{
			...
			schema:      Schema{Type: Types{"number"}, Maximum: ptrFloat64(10)},
			data:        10.0,
			expectValid: true,
		},
		{
		...
		},
		{
			...
			schema:      Schema{Type: Types{"number"}, ExclusiveMaximum: ptrFloat64(10)},
			data:        9.9,
			expectValid: true,
		},
		{
		...
		},
		{
			...
			schema:      Schema{Type: Types{"number"}, MultipleOf: ptrFloat64(0.5)},
			data:        1.5,
			expectValid: true,
		},
		{
		...
		// --- Array Validation ---
		{
			...
			schema:      Schema{Type: Types{"array"}, MinItems: ptrInt64(1)},
			data:        []any{1},
			expectValid: true,
		},
		{
		...
		},
		{
			...
			schema:      Schema{Type: Types{"array"}, UniqueItems: true},
			data:        []any{1, 2, 3},
			expectValid: true,
		},
		{
		...
		},
		{
			...
			schema: Schema{
				Type:  Types{"array"},
				Items: &Schema{Type: Types{"string"}},
			},
			data:        []any{"a", "b"},
			expectValid: true,
		},
		...
		},
		{
			...
			schema: Schema{
				...
				Properties: Properties{
					{Name: "name", Schema: Schema{Type: Types{"string"}}},
				},
			},
			data:        map[string]any{"name": "test"},
			expectValid: true,
		...
		// --- Format Validation ---
		{
			...
			schema:      Schema{Type: Types{"string"}, Format: "date-time"},
		...
		},
		{
			...
			schema:      Schema{Type: Types{"string"}, Format: "ipv4"},
			data:        "192.168.1.1",
			expectValid: true,
		},
		{
		...
		},
		{
			...
			schema: Schema{
				OneOf: []Schema{
					{Type: Types{"number"}, MultipleOf: ptrFloat64(5)},
					{Type: Types{"number"}, MultipleOf: ptrFloat64(3)},
				},
			},
